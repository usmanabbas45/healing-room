    ...
    <footer className="px-6 py-16 border-t border-solid pointer-events-auto bg-bg-alt border-border-primary">
      <nav className="flex flex-wrap justify-around gap-8 mx-auto max-w-screen-2xl">
        ...
        <div className="w-full max-w-xs">
          <h2 className="my-3 text-sm font-semibold text-text-primary">Find Us</h2>
        ...
        {/* Hours Section */}
        <div className="w-full max-w-xs">
          <h2 className="my-3 text-sm font-semibold text-text-primary">Hours</h2>
          <p className="text-sm text-text-light mb-2">Open 7 Days a Week</p>
        ...
        {/* Quick Links Section */}
        <div className="w-full max-w-xs">
          <h2 className="my-3 text-sm font-semibold text-text-primary">Quick Links</h2>
          <ul>
